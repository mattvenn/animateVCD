...
instructions = ["nop", "read1", "read2", "add", "mult", "write"]
...
animators = [
    ...
    StyleReplacer(svg_id='pip1', vcd_id='memory_1', replace=(pipe_colour_1, pipe_colour_2), compare=isHigh()),
    StyleReplacer(svg_id='pip2', vcd_id='memory_2', replace=(pipe_colour_1, pipe_colour_2), compare=isHigh()),
    StyleReplacer(svg_id='pip3', vcd_id='add',      replace=(pipe_colour_1, pipe_colour_2), compare=isHigh()),
    StyleReplacer(svg_id='pip4', vcd_id='mult',     replace=(pipe_colour_1, pipe_colour_2), compare=isHigh()),
...
# files
svg_file = "examples/MARLANN/pipeline.svg"
